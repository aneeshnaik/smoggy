...
Created: Nay 2019
Author: A. P. Naik
Description: 2D solvers for chameleon and f(R) gravity
"""
from .constants import kpc, Mpc, pi, G
import numpy as np
...
class MGGrid:
    ...
    def newton(self, expu, D2expu):
        ...
        L = D2expu + self.__const1*(expu**2 - self.rho/self.rho_mean)
    ...
    def iter_solve(self, niter, beta, verbose=False, tol=1e-7):
        """
